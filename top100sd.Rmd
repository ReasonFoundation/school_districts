...
dictionary <- readRDS("dictionary.RDS") %>% 
  add_row(
    ncesID = "4703180", name = "Davidson County Board of Education", 
    id = "1267426", state = "TN"
  )
...
saveRDS(nyc_20_21_22, "nyc_20_21_22.RDS")  
